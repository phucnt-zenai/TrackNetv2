...
def set_seed(seed=42):
    ...
    torch.backends.cudnn.benchmark = False  # Set to True for performance if exact reproducibility isn't needed
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume_pruning_ckpt', type=str, default='')
    ...
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=batch_size, drop_last=True, pin_memory=True, worker_init_fn=seed_worker, generator=g)
